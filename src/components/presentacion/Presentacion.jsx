      ...
      <Container className=" container containerPresentacion" width={100}>
        <Row className="m-0 p-0 rowSobreMi " height={100}  width={100}>
          <Col xl={6} md={6} sm={12} xs={12} className="colPresentacion">
            <Row>
              <h2 className="miNombre">Martina Soria Lanzi</h2>
            <p className="miCarrera m-0">FullStack Developer</p>
              <p className="miCarrera mt-0">Ingeniera Industrial</p>
              <Col>
          ...
          <Col xl={6} md={6} sm={12} xs={12} className="colWomanDev ">
            <img src={womanDev} className="womanDevPic img-fluid"  alt="imagenCv"></img>
          </Col>
        </Row>
      </Container>
    </>
